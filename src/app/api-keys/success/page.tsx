      ...
      <div className="max-w-md space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Ihr <strong className="text-foreground">API-Key</strong> wird Ihnen per E-Mail zugestellt — bitte auch den Spam-Ordner prüfen.
          </p>
        </div>
        <p className="text-sm text-muted-foreground">
          Der Magic-Link im Mail ist 30 Tage gültig und führt direkt zu Ihrem Dashboard.
        </p>
        <Link
          href="/"
